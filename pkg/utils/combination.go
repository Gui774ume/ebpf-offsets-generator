package utils // Package combinations provides a method to generate all combinations out of a given string array.

import "math/bits"

// GenerateCombinations returns all combinations for a given string array.
